...
REF_MODEL_PATH="${REF_MODEL_PATH:-${SLIME_ROOT}/outputs/init_ckpts/30b/iter_0000150}"
REF_MODEL_TORCH_DIST="${REF_MODEL_TORCH_DIST:-${SLIME_ROOT}/outputs/converted_ckpts/qw30b_a3b_iter150_torch_dist}"
...
CKPT_ARGS=(
  --hf-checkpoint ${REF_MODEL_PATH}/HF/
  ...
  --tokenizer-model ${REF_MODEL_PATH}/HF/
  --no-load-rng
)
