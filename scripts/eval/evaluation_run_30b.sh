...
LOG_FILE="${SLIME_ROOT}/test_eval_30b.log"
...
EXP_TAG="eval-qwen3-30B-A3B-2507-rubric0.3-rop"
REF_MODEL_PATH="${REF_MODEL_PATH:-${SLIME_ROOT}/outputs/run-qwen3-30B-A3B-2507-search_deepdive-64k-rubric0.3-normal-rop/iter_0000419}"
